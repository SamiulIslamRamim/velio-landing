...
import encrypt from "../assets/images/encrypted.svg";
  ...
  return (
    <div className="feature">
      ...
      <div className="featgrid">
        <div className="grid1">
          <div className="fgrid">
            <div className="fgridtop">
              ...
              <div className="fgridtitle">Fast and Easy</div>
              <div className="fgriddes">
                Go live in minutes with guided onboarding and zero‑code widgets,
                or integrate via our clean, well‑documented API.
              </div>
            </div>
            {/* down */}
          ...
          <div className="fgrid">
            <div className="fgridtop">
              ...
              <div className="fgridtitle">Financial Management</div>
              <div className="fgriddes">
                A unified ledger, automated reconciliation, and export‑ready
                reports for accounting—so month‑end closes faster.
              </div>
            </div>
            <div className="fgriddown">
          ...
          <div className="fgrid">
            <div className="fgridtop">
              ...
              <div className="fgridtitle">Subscription Control</div>
              <div className="fgriddes">
                Launch plans, trials, coupons, and proration in a few clicks.
                Reduce churn with automated dunning and smart retries.
              </div>
            </div>
            <div className="fgriddown">
              <div className="trans">
        ...
        <div className="grid2">
          <div className="sgrid">
            <div className="sgridtop">
              <div className="sgridicon">
                <img src={clock} alt="c" />
              </div>
              <div className="sgridtitle">Real-time Tracking</div>
              <div className="sgriddes1">
                See volume, approval rates, and cohort trends live. Spot issues
                early and act with confidence.
              </div>
            </div>
            <div className="sgriddown">
              <div className="sav">
                <div className="saving">
                  Saving Growth
                </div>
                <div className="savper">
                  <div>
                    35%
                  </div>
                  <div className="savpa">
              ...
              <div className="bar">
                <div className="barb"><div className="bar1"></div></div>
                <div className="barb"><div className="bar2"></div></div>
                <div className="barb"><div className="bar3"></div></div>
                <div className="barb"><div className="bar4"></div></div>
              </div>
            </div>
          </div>
          ...
          <div className="sgrid">
            <div className="sgridtop">
              <div className="sgridicon">
                <img src={encrypt} alt="c" />
              </div>
              <div className="sgridtitle">Secure Encryption</div>
              <div className="sgriddes">
                End‑to‑end encryption, PCI‑compliant flows, SCA/3DS support, and
                risk tools to keep fraudulent activity out.
              </div>
            </div>
            <div className="sgriddown">
              <div className="sgriddown1">
                <div className="baltex">Total Balance</div>
                <div className="balnum">
                  <div>$12,773.00</div>
                  <img src={chokh} alt="chokh" className="chok" />
              ...
              <div className="lsection">
                <div className="section">
                  ...
                  <div className="ltext">
                    <div>Sent</div>
                    <div className="lamount">$1,275</div>
                  </div>
                </div>
                <div className="section">
                  <div className="lock">
